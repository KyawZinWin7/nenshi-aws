                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="divide-y divide-gray-200 text-sm">
                            <tr v-for="department in departments.data" :key="department.id">
                                ...
                                <td class="whitespace-nowrap py-3 pl-4 pr-3 text-gray-900 sm:pl-6">{{ department.name }}
                                </td>

                                <td class="whitespace-nowrap py-3 pl-4 pr-3 text-gray-900 sm:pl-6">{{ department.department_code }}
                                </td>
